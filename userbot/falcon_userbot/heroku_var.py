...
class config(object):
    ...
    FALCON_NAME = os.environ.get("FALCON_NAME", None)
    ...
    UPSTREAM_REPO_URL = os.environ.get("UPSTREAM_REPO_URL","https://github.com/Zylern/Falcon")
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "Falcon")
    CONSOLE_LOGGER_VERBOSE = sb(os.environ.get("CONSOLE_LOGGER_VERBOSE", "False"))
