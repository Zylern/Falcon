...
async def a():
  ...
  os.system("rm userbot/modules/*.py") ; LOGS.info(f"WEW your userbot is active now with {o}{o2}{o3}{o4} check it by typing .alive in any chat, type  .help for more info.")
